...
# Obtener y ordenar alfabéticamente los archivos Excel
archivos_excel = sorted(
    [f for f in os.listdir(carpeta_excels) if f.endswith(".xlsx")]
)
...
for archivo in archivos_excel:
    ...
    done_flag = os.path.join(carpeta_logs, f"{nombre_base}.done")
    if os.path.exists(done_flag):
        print(f"Archivo ya procesado completamente: {archivo} — se omite.")
        continue
    ...
    # Marcar como completamente procesado
